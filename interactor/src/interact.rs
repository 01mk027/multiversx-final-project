...
impl ContractInteract {
    pub async fn new() -> Self {
        ...
        interactor.set_current_dir_from_workspace("stakex");
    ...
    pub async fn calculate_rewards(&mut self) {
